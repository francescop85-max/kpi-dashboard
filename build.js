...
function renderComp3Trend(trend){
  ...
  mou('chart-comp-trend',{type:'bar',data:{labels,datasets:[
    {type:'bar',label:'Competitive',data:compPcts,backgroundColor:'rgba(0,51,102,.75)',stack:'s',order:2},
    {type:'bar',label:'Direct',data:trend.map(d=>d.dirPct),backgroundColor:'rgba(158,202,225,.75)',stack:'s',order:2},
    {type:'line',label:'Target (70%)',data:trend.map(()=>70),borderColor:'#f59e0b',borderWidth:1.5,borderDash:[6,4],pointRadius:0,fill:false,order:0,tension:0,stack:undefined},
    {type:'line',label:\`Trend (\${trendUp?'↑ improving':'↓ declining'})\`,data:regLine,
     borderColor:trendColor,borderWidth:2.5,borderDash:[],pointRadius:0,fill:false,order:1,tension:0,stack:undefined},
  ]},options:{responsive:true,
    plugins:{legend:{labels:{color:tc(),filter:i=>i.text!==undefined}},datalabels:{display:false},
...
function renderPlan4Trend(trend){
  ...
  mou('chart-plan-trend',{type:'bar',data:{labels,datasets:[
    {type:'bar',label:'Planned',data:pPct,backgroundColor:'rgba(0,51,102,.75)',stack:'s',order:2},
    {type:'bar',label:'Unplanned',data:uPct,backgroundColor:'rgba(192,57,43,.75)',stack:'s',order:2},
    {type:'line',label:'Target (70%)',data:tracked.map(()=>70),borderColor:'#f59e0b',borderWidth:1.5,borderDash:[6,4],pointRadius:0,fill:false,order:0,tension:0,stack:undefined},
    {type:'line',label:\`Trend (\${trendUp4?'↑ improving':'↓ declining'})\`,data:regLine4,
     borderColor:trendColor4,borderWidth:2.5,pointRadius:0,fill:false,order:1,tension:0,stack:undefined},
  ]},options:{responsive:true,
